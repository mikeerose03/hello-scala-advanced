...
//  pool.shutdown()
//  pool.execute(() => println("should not appear")) // app crashes since the pool in shut down

//  pool.shutdownNow() // stops immediately and interrupts running threads and cause the app to crash
...
//    println()
  ...
  * */
  ...
  // solutions to solve race condition problems
